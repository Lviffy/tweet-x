            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-muted-foreground">
                  Based on analyzed writing patterns (click to view full tweet)
                </p>
              </CardHeader>
              <CardContent className="space-y-4">
          ...
          <DialogHeader>
            <DialogTitle className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground font-normal">
                  {selectedTweet && formatDate(selectedTweet.timestamp)}
                </p>
              </div>
            </DialogTitle>
          </DialogHeader>
          ...
          {selectedTweet && (
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-6 text-sm text-muted-foreground border-t pt-4">
                ...
                <span className="flex items-center gap-2">
                  ❤️ {Math.floor(Math.random() * 100)} likes
                </span>
              </div>
              ...
              {selectedTweet.isThread && (
                <div className="bg-muted/50 rounded-lg p-3">
                  <p className="text-sm text-muted-foreground">
                    This is part of a thread. The full thread would contain multiple connected tweets exploring this topic in depth.
                  </p>
                </div>
              )}
            </div>
